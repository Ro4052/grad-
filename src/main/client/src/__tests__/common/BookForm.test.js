...
describe("Testing the book form", () => {
  beforeEach(() => {
    wrapper = shallow(
      <BookForm book={newBook} buttonText="Add Book">
        {" "}
      </BookForm>
    );
  });
  ...
  test("Leading white spaces not allowed", () => {
    wrapper
      .find("#isbn")
      .simulate("change", { target: { id: "isbn", value: "     2321" } });
    wrapper
      .find("#title")
      .simulate("change", { target: { id: "title", value: "     Title1" } });
    wrapper
      .find("#author")
      .simulate("change", { target: { id: "author", value: " Author1" } });
    wrapper
      .find("#publishDate")
      .simulate("change", { target: { id: "publishDate", value: "     1" } });
  ...
  test("Test publish Date is sliced to 4 digits", () => {
    wrapper
      .find("#publishDate")
      .simulate("change", { target: { id: "publishDate", value: "123111" } });
